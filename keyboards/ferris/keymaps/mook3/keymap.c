...
// qmk compile -kb ferris/sweep -km mook3 -e CONVERT_TO=promicro_rp2040
...
_______, _______, _______, _______, _______,					 _______, _______, _______, _______, TG_GAM ,
	...
	[_SYMBOLS] = LAYOUT(
KC_AMPR, KC_PLUS, KC_UNDS, KC_LCBR, KC_RCBR, 					 _______, KC_COLN, KC_HASH, KC_CIRC, _______,
KC_EXLM, KC_EQL , KC_PMNS, KC_LPRN, KC_RPRN, 					 _______, KC_SCLN, KC_DLR , KC_AT  , KC_PERC,
