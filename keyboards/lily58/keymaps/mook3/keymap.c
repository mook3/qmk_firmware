...
_______, KC_PIPE, KC_ASTR, KC_TILD, KC_LBRC, KC_RBRC, _______,	_______, _______, KC_GRV , KC_LT  , KC_GT  , KC_BSLS, _______,
	...
	[_NUMBERS] = LAYOUT(
_______, _______, _______, _______, _______, _______,					 _______, _______, _______, _______, _______, _______,
_______, _______, KC_1   , KC_2   , KC_3   , KC_PMNS,					 KC_WH_U, KC_HOME, KC_UP  , KC_END , _______, _______,
_______, KC_0   , KC_4   , KC_5   , KC_6   , _______, 					 KC_WH_D, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL , _______,
_______, _______, KC_7   , KC_8   , KC_9   , KC_PENT, _______,	_______, _______, KC_TAB , KC_ESC , _______, _______, _______,
				  _______, _______, _______, _______,					 _______, _______, _______, _______),
